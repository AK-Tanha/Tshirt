    ...
    <main className="pb-24">
      ...
      <section className="relative h-screen w-full overflow-hidden bg-black flex items-center">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 w-full">
          <div className="max-w-2xl">
            ...
            >
              <span className="font-mono text-white/40 uppercase tracking-widest text-xs mb-6 block">
                Collection 2026
              </span>
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                <Link
                  href="/products"
                  className="bg-white text-black px-8 sm:px-10 py-4 font-body text-sm font-medium hover:bg-white/90 transition-all duration-300 rounded-lg text-center"
                >
                  Explore Shop
                </Link>
                <Link
                  href="/products?category=polo"
                  className="border border-white/20 text-white px-8 sm:px-10 py-4 font-body text-sm font-medium hover:bg-white hover:text-black transition-all duration-300 rounded-lg text-center"
                >
                  Shop Polos
                </Link>
              </div>
      ...
      {categories.map((cat) => {
        ...
        return (
          <section
            key={cat.id}
            className="max-w-7xl mx-auto px-6 md:px-12 pt-20"
          >
            <div className="flex justify-between items-end mb-12">
              <MotionSection>
                <span className="font-mono text-muted uppercase tracking-widest text-[10px] mb-2 block">
