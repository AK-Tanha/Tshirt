    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <Link
          ...
          className="flex items-center gap-2 px-4 py-2.5 bg-neutral-900 text-white text-sm font-medium rounded-lg hover:bg-neutral-800 dark:bg-white dark:text-neutral-900 dark:hover:bg-neutral-200 transition-colors"
        >
      ...
      <Card>
        <div className="flex flex-col sm:flex-row gap-3">
          ...
          <select
            ...
            className="px-4 py-2.5 bg-neutral-100 dark:bg-neutral-900 border-none rounded-lg text-sm text-neutral-500 outline-none focus:ring-2 focus:ring-neutral-300 dark:focus:ring-neutral-700 transition-all"
          >
          ...
          <button className="flex items-center gap-2 px-4 py-2.5 bg-neutral-100 dark:bg-neutral-900 rounded-lg text-sm text-neutral-500 hover:text-neutral-900 dark:hover:text-white transition-colors">
        ...
        {selected.size > 0 && (
          <div className="flex items-center gap-3 px-4 py-3 bg-neutral-100 dark:bg-neutral-900 rounded-lg text-sm">
            <span className="font-medium">{selected.size} selected</span>
            <button className="text-red-600 hover:text-red-700 font-medium">Delete Selected</button>
            <button className="text-neutral-500 hover:text-neutral-900 dark:hover:text-white font-medium" onClick={() => setSelected(new Set())}>Clear</button>
          </div>
        )}
      </Card>
          ...
          <table className="w-full">
            ...
            <tbody>
              {filtered.map((product) => {
                ...
                return (
                  <tr key={product.id} className="border-t border-border text-sm hover:bg-neutral-50 dark:hover:bg-neutral-900/50 transition-colors">
                    <td className="p-4">
                      <input
                        type="checkbox"
                    ...
                    <td className="p-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div className="min-w-0">
                          <Link href={`/admin/products/${product.id}`} className="font-medium truncate hover:text-neutral-600 dark:hover:text-neutral-300 transition-colors">
                            {product.name}
                          </Link>
