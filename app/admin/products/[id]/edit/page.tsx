    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <Link
            ...
            className="flex items-center gap-2 px-4 py-2.5 border border-border text-sm font-medium rounded-lg hover:bg-neutral-100 dark:hover:bg-neutral-800 transition-colors"
          >
          ...
          <button
            onClick={handleSave}
            disabled={saving}
            className="flex items-center gap-2 px-5 py-2.5 bg-neutral-900 text-white dark:bg-white dark:text-neutral-900 text-sm font-medium rounded-lg hover:bg-neutral-800 dark:hover:bg-neutral-200 transition-colors disabled:opacity-50"
          >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <Card className="p-6 space-y-5">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <Field label="Category">
                  <select
                    ...
                    className="w-full px-4 py-2.5 bg-white dark:bg-neutral-900 border border-border rounded-lg text-sm outline-none focus:border-neutral-900 dark:focus:border-white transition-colors"
                  >
              ...
              <Field label="Description">
                <textarea
                  ...
                  rows={4}
                  className="w-full px-4 py-2.5 bg-white dark:bg-neutral-900 border border-border rounded-lg text-sm outline-none focus:border-neutral-900 dark:focus:border-white transition-colors resize-none placeholder:text-neutral-400"
                />
              </Field>
            </Card>
          )}
          ...
          {activeTab === 'images' && (
            <Card className="p-6 space-y-6">
              ...
              {product?.heroImage && heroImages.length === 0 && (
                <div className="relative w-full aspect-video rounded-lg overflow-hidden bg-neutral-100 dark:bg-neutral-800 border border-border">
              ...
              {product?.extraImages && product.extraImages.length > 0 && extraImages.length === 0 && (
                <div className="grid grid-cols-4 gap-3">
                  {product.extraImages.map((img, i) => (
                    <div key={i} className="relative aspect-square rounded-lg overflow-hidden bg-neutral-100 dark:bg-neutral-800 border border-border">
          ...
          {activeTab === 'variants' && (
            <Card className="p-6 space-y-5">
              <div className="flex items-center justify-between">
                ...
                <button
                  onClick={addVariant}
                  className="flex items-center gap-1.5 px-3 py-1.5 text-sm font-medium border border-border rounded-lg hover:bg-neutral-100 dark:hover:bg-neutral-800 transition-colors"
                >
                      ...
                      <tr key={v.id} className="border-b border-border/50">
                        <td className="py-2 pr-2">
                          <select
                            ...
                            className="w-full px-3 py-2 bg-white dark:bg-neutral-900 border border-border rounded-lg text-sm outline-none focus:border-neutral-900 dark:focus:border-white transition-colors"
                          >
                        ...
                        <td className="py-2 px-2">
                          <input
                            ...
                            className="w-full px-3 py-2 bg-white dark:bg-neutral-900 border border-border rounded-lg text-sm outline-none focus:border-neutral-900 dark:focus:border-white transition-colors font-mono text-xs"
                          />
                        </td>
                        <td className="py-2 pl-2">
                          <input
                            ...
                            min={0}
                            className="w-20 px-3 py-2 bg-white dark:bg-neutral-900 border border-border rounded-lg text-sm outline-none focus:border-neutral-900 dark:focus:border-white transition-colors text-right"
                          />
                        </td>
                        <td className="py-2">
                          <button
        ...
        <div className="space-y-4">
          ...
          <Card className="p-5">
            ...
            <div className="space-y-2">
              <button
                onClick={handleSave}
                disabled={saving}
                className="w-full flex items-center justify-center gap-2 px-4 py-2.5 bg-neutral-900 text-white dark:bg-white dark:text-neutral-900 text-sm font-medium rounded-lg hover:bg-neutral-800 dark:hover:bg-neutral-200 transition-colors disabled:opacity-50"
              >
              ...
              <button
                onClick={() => router.back()}
                className="w-full px-4 py-2.5 border border-border text-sm font-medium rounded-lg hover:bg-neutral-100 dark:hover:bg-neutral-800 transition-colors"
              >
                Cancel
              </button>
            </div>
          ...
          <Card className="p-5 bg-yellow-50 dark:bg-yellow-950/20 border-yellow-200 dark:border-yellow-900">
            <div className="flex gap-2">
              <AlertCircle className="w-4 h-4 text-yellow-600 dark:text-yellow-400 shrink-0 mt-0.5" />
              <div>
                <p className="text-sm font-medium text-yellow-800 dark:text-yellow-300">Draft Mode</p>
                <p className="text-xs text-yellow-700 dark:text-yellow-400 mt-0.5">Changes are saved to your browser session and will be lost on cache clear.</p>
              </div>
            </div>
          </Card>
        </div>
