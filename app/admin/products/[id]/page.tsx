...
export default function ProductDetailPage() {
 ...
 selectedImage === product.heroImage ? 'border-neutral-900 ' : 'border-transparent',
 )}
 >
 ...
 className={cn(
 'relative w-14 h-14 rounded-lg overflow-hidden border-2 transition-colors',
 selectedImage === img ? 'border-neutral-900 ' : 'border-transparent',
 )}
 >
 ...
 <p className="text-sm text-neutral-600 mt-1 leading-relaxed">{product.description}</p>
 </div>
 </div>
 </div>
 </Card>
