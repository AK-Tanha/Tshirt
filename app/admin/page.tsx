      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <Card className="lg:col-span-2 p-6">
          <CardHeader>
            <div>
              ...
              <p className="text-[11px] text-neutral-500 mt-0.5">
                Monthly revenue for fiscal year 2026
              </p>
            </div>
          ...
          <div className="flex items-center justify-between mt-4 pt-4 border-t border-border text-[11px] text-neutral-500">
            <span>
              Highest: ৳{maxRevenue.toLocaleString()} (
              {revenueByMonth.find((r) => r.revenue === maxRevenue)?.month})
            </span>
            <span className="flex items-center gap-1">
              <TrendingUp className="w-3 h-3 text-emerald-600" />
              <span className="text-emerald-600 font-medium">+12.5%</span> vs
              last year
            </span>
          </div>
        </Card>
